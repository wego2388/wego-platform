...
interface SiteCopy {
  languageName: string;
  preview: string;
  nav: { discover: string; about: string; contact: string };
  ...
  footer: string;
  discover: { heading: string; body: string; back: string; whatsapp: string; viewSystem: string; offeringPreview: string; pricingNotice: string };
  about: {
    heading: string;
    body: string;
    factsHeading: string;
...
export const siteCopy: Record<SdcLocale, SiteCopy> = {
  en: {
    ...
    nav: { discover: "Discover", about: "About", contact: "Contact" },
    hero: {
    ...
    categoriesBody: "These are the real categories of what Sharm Divers Club runs. Prices are still under owner review, so nothing here is shown as a final, bookable rate.",
    categories: [
      { eyebrow: "From the beach", title: "Shore diving", description: "Intro dives for first-timers and guided shore dives for certified divers, right from Sharm." },
      { eyebrow: "By boat", title: "Boat diving", description: "Day trips to Ras Mohammed and Tiran, for beginners and certified divers alike." },
      { eyebrow: "Several days", title: "Multi-day packages", description: "3 to 7 day dive packages combining shore and boat days for divers with more time." },
      { eyebrow: "The full route", title: "Signature packages", description: "\"Red Sea Icons\" — a proposed multi-day route across the region's best-known sites." },
      { eyebrow: "The highlights", title: "World-class sites", description: "SS Thistlegorm, Dahab's Blue Hole & Canyon, Tiran drift diving, Ras Mohammed's Shark & Yolanda." },
      { eyebrow: "Get certified", title: "PADI courses", description: "Open Water through Divemaster, plus Nitrox and Emergency First Response." },
    ],
    ...
    footer: "Sharm Divers Club · Royal Grand Sharm Hotel, Hadabet Um Sid, Sharm El Sheikh",
    discover: {
      heading: "Pricing is still under owner review",
      body: "Categories, sites and courses shown here are real. Prices, availability and photos will appear only after they are approved for publication.",
      back: "Back to the overview",
      whatsapp: "Ask for current pricing on WhatsApp",
      viewSystem: "View the living design system",
      offeringPreview: "See an offering detail preview",
      pricingNotice: "Preview — pricing pending owner approval",
    },
    about: {
  ...
  ar: {
    ...
    nav: { discover: "استكشف", about: "من نحن", contact: "تواصل" },
    hero: {
    ...
    categoriesBody: "دي الفئات الحقيقية لخدمات Sharm Divers Club. الأسعار لسه تحت مراجعة المالك، فمفيش سعر نهائي ظاهر هنا.",
    categories: [
      { eyebrow: "من الشاطئ", title: "غطس الشاطئ", description: "غطسات تجريبية للمبتدئين وغطسات شاطئ موجهة للغواصين المعتمدين، من شرم مباشرة." },
      { eyebrow: "بالقارب", title: "غطس القارب", description: "رحلات يوم كامل لرأس محمد وتيران، للمبتدئين والغواصين المعتمدين." },
      { eyebrow: "عدة أيام", title: "باقات متعددة الأيام", description: "باقات من 3 إلى 7 أيام تجمع بين أيام الشاطئ والقارب لمن عنده وقت أطول." },
      { eyebrow: "المسار الكامل", title: "الباقات المميزة", description: "\"أيقونات البحر الأحمر\" — مسار مقترح متعدد الأيام يغطي أشهر مواقع المنطقة." },
      { eyebrow: "أهم المواقع", title: "مواقع عالمية", description: "حطام SS Thistlegorm، وBlue Hole وCanyon في دهب، وDrift Diving في تيران، وShark & Yolanda في رأس محمد." },
      { eyebrow: "احصل على شهادة", title: "دورات PADI", description: "من Open Water لحد Divemaster، بالإضافة لـNitrox وEmergency First Response." },
    ],
    ...
    footer: "Sharm Divers Club · فندق Royal Grand Sharm، هضبة أم السيد، شرم الشيخ",
    discover: {
      heading: "الأسعار لسه تحت مراجعة المالك",
      body: "الفئات والمواقع والدورات الظاهرة هنا حقيقية. الأسعار والتوفر والصور هتظهر بس بعد الموافقة على نشرها.",
      back: "العودة للنظرة العامة",
      whatsapp: "اسأل عن الأسعار الحالية على واتساب",
      viewSystem: "شاهد نظام التصميم الحي",
      offeringPreview: "شاهد معاينة لتفاصيل خدمة",
      pricingNotice: "معاينة — الأسعار في انتظار موافقة المالك",
    },
    about: {
