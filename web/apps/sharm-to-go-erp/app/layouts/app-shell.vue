...
// app's own nav groups and brand label — same reasoning throughout: no new
// authorization logic here, every nav link is shown unconditionally (the
// same static-nav approach the old flat header already used), and each
// destination page's own existing permission checks are the real gate.
