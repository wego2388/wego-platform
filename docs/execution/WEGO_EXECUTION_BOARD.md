...
| WEGO-012 | Platform administration: staff accounts/RBAC, a real super-admin dashboard, HR (employees, attendance, leave, payroll), and a full double-entry accounting module | IN PROGRESS — Phases 1-2 (accounts/roles/permissions, super-admin dashboard) complete; Phases 3-7 (HR, accounting) not started |
