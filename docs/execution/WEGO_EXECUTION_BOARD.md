...
| WEGO-012 | Platform administration: staff accounts/RBAC, a real super-admin dashboard, HR (employees, attendance, leave, payroll), and a full double-entry accounting module | IN PROGRESS — Phases 1-5 (accounts/roles/permissions, super-admin dashboard, HR employee records, attendance/leave requests, chart of accounts + double-entry journal) complete; Phases 6-7 (payroll, financial reports) not started |
