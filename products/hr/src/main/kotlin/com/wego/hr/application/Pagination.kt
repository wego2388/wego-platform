...
internal object Pagination {
     ...
     * `page` and wrap to a negative offset, which jOOQ would reject or
     * mishandle downstream. An absurdly large result clamps to
     * `Int.MAX_VALUE`, which simply yields zero rows — a safe outcome.
     */
    fun offsetFor(
        page: Int,
        size: Int,
