# Sharm Divers Club client profile

This directory contains only the minimum declarative configuration needed to
prove Wego Platform + Wego Divers + Sharm Divers Club. It does not contain
client-specific executable code, secrets, price lists, marketing automation,
or diving workflows.
...
Facts from the marketing reference are not automatically authoritative Wego
